    ...
    <div id="app">
        ...
        <form action="{{ url('/login') }}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    <button type="submit" class="btn btn-primary pull-right" style="border-radius: 15px;">Sign In</button>
                </div><!-- /.col -->
            </div>
        </form>
        <a href="{{ url('/register') }}" class="text-center">Buat Akun Terlebih Dahulu</a>
