			...
			<div class="col-md-8 col-md-offset-2">
				<div class="box box-primary animated fadeInDown">
					...
					<div class="box-body">
						...
						@endif
						<form action="{{url('meja/update/'.$meja->id)}}" method="POST" class="form-group">
							{{csrf_field()}}
							<div class="form-group row">
								<label class="label-control col-md-4">No Meja</label>
									<div class="col-md-8">
									<input type="text" name="no_meja" class="form-control" value="{{$meja->no_meja}}">
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row col-md-4">
								<input type="submit" class="btn btn-primary" value="Edit">  <a href="{{url('meja')}}" class="btn btn-danger">Batal</a>
							</div>
						</form>
					</div>
				</div>
